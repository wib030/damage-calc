...
function getMoveEffectiveness(gen, move, type, isGhostRevealed, isGravity, isRingTarget, defender, attacker) {
    ...
    else if ((attacker === null || attacker === void 0 ? void 0 : attacker.hasAbility('Corrosion')) && type === 'Steel' && move.hasType('Poison')) {
        return 1;
    }
...
function checkIntimidate(gen, source, target) {
    var blocked = target.hasAbility('Clear Body', 'White Smoke', 'Hyper Cutter', 'Full Metal Body', 'Inner Focus', 'Own Tempo', 'Oblivious', 'Scrappy', 'Guts', 'Rivalry', 'Unaware', 'Vital Spirit', 'Forewarn', 'Anticipation', 'Huge Power', 'Pure Power', 'Hustle', 'Pressure', 'Reckless', 'Simple', 'Truant') ||

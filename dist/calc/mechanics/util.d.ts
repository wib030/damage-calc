...
export declare function computeFinalStats(gen: Generation, attacker: Pokemon, defender: Pokemon, field: Field, move: Move, ...stats: StatID[]): void;
export declare function getFinalSpeed(gen: Generation, pokemon: Pokemon, field: Field, side: Side, move: Move): number;
export declare function getMoveEffectiveness(gen: Generation, move: Move, type: TypeName, isGhostRevealed?: boolean, isGravity?: boolean, isRingTarget?: boolean, defender?: Pokemon, attacker?: Pokemon): number;
